// ============================================
//  MAIN.JS — Lógica, animaciones y render
// ============================================
  ...
  DATA.skills.forEach((sk, i) => {
    ...
    el.innerHTML = `
      ...
      <div class="skill-track">
        <div class="skill-bar" data-width="${sk.level}"></div>
      </div>`;
    grid.appendChild(el);
  });
}
...
function renderTimeline() {
  ...
  DATA.experience.forEach((exp, i) => {
    const el = document.createElement('div');
    el.className = `timeline-item reveal ${i % 2 === 0 ? 'delay-1' : 'delay-2'}`;
    el.innerHTML = `
...
function renderProjects() {
  ...
  DATA.projects.forEach((p, i) => {
    const el = document.createElement('div');
    el.className = `project-card reveal delay-${i + 1}`;
    el.innerHTML = `
...
function renderEducation() {
  ...
  uniSection.className = 'edu-section reveal';
  ...
  certSection.className = 'edu-section reveal delay-1';
...
function renderContact() {
  ...
  DATA.contact.forEach((c, i) => {
    ...
    el.className = `contact-card reveal delay-${i + 1}`;
    el.href = c.href;
